<script>
  ...
  import GQLLogin from 'siskom-web-admin/graphql/Login.js';
  import GQLCurrentUser from 'siskom-web-admin/graphql/CurrentUser.js';
  import { user } from'siskom-web-admin/stores/index.js';
  import 'siskom-web-admin/styles/auth.css';
