...
<nav class="bg-indigo-900 text-white fixed top-0 left-0 right-0 text-sm">
  <div class="px-4 flex items-center h-10">
    <div class="flex items-center">
      <img alt="logo" class="mr-2" src={logo} height={logoSize} width={logoSize} />
      <span class="font-bold tracking-wider text-base">siskom</span>
    </div>
